...
- Be explicit about package ownership in docs when a feature migrates between `pi-extensions` and `pi-extensions-oss`. Avoid overlapping tool registration surfaces across the two packages.
